...
class lactuerTablePage(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.logo_label = ctk.CTkLabel(self.navframe, text="lactuer Table Screen Page",text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"))
        ...
        self.lacTable.pack(side="top" ,fill="both", expand="true")
         # create textbox
        self.scrollable_frame2 = ctk.CTkScrollableFrame(self.lacTable,label_fg_color="white",label_text_color="dark blue", label_text="Lactuer List")
        ...
        self._label = ctk.CTkLabel(master=self.regestForm1,width=300,text= 'Add Lactuer Table' ,text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"),wraplength=300,fg_color="transparent",)
        ...
        self._label = ctk.CTkLabel(master=self.regestForm,text= 'Subj Name' ,width=50,wraplength=300,fg_color="transparent",text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"))
        self._label.place(x=30, y=50)
        self.Subj_Name = ctk.CTkComboBox(self.regestForm,width=200,fg_color="white", button_color= 'dark blue',border_width=2,
                                       values=self.subjectName() )
        self.Subj_Name.place(x=130, y=50)
        
        self._label = ctk.CTkLabel(master=self.regestForm,text= 'Date', width=50,wraplength=300,fg_color="transparent",text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"))
        ...
        self._label = ctk.CTkLabel(master=self.regestForm,text= 'Teacher', width=50,wraplength=300,fg_color="transparent",text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"))
        self._label.place(x=30, y=150)
        self.Teacher = ctk.CTkComboBox(self.regestForm,width=200,fg_color="white", button_color= 'dark blue',border_width=2,
        ...
        self._ok_button = ctk.CTkButton(master=self.regestForm,width=100,border_width=0,text='Add',fg_color="dark blue",command= self.save_Lac_table)
        self._ok_button.place(x=50, y=200)
        
        
        self._ok_button = ctk.CTkButton(master=self.regestForm,width=100,border_width=0,text='Edite',fg_color="dark blue")
        self._ok_button.place(x=160, y=200)
        
        
        self._ok_button = ctk.CTkButton(master=self.regestForm,width=100,border_width=0,text='Delete',fg_color="dark blue")
        self._ok_button.place(x=270, y=200)

    def Dataview(self):
        headers = ['Day',"Time","Subj Name", "Teacher"]    
        for col, header in enumerate(headers):
            self.label = ctk.CTkLabel(self.scrollable_frame2,fg_color='dark blue',text_color='white',width=130,corner_radius=3, text=header,font=("Arial", 12, "bold"))
        ...
        for row, row_data in enumerate(data, start=1):
            for col, value in enumerate(row_data):
                entry = ctk.CTkLabel(self.scrollable_frame2,text=value,text_color='dark blue', fg_color='white', width=130)
    ...
    def save_Lac_table(self):
        self.lacTableFun.addLacTable(self.Subj_Name.get(),self.Date.get(),'18/8/2024',self.Teacher.get())
