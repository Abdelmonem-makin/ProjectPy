...
from Fun.studantFun  import studantFun as std
from Fun.SubjectFun  import SubjecFun as sub
from Fun.teacherFun  import teacherFun as teach
import Attendance
...
class HomePage(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.Techer_label = ctk.CTkLabel(self.mainFrame, text=std.count_all_rows(self),width=110,height=80,fg_color='white',text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"))
        self.Techer_label.pack(side="left",fill="both",ipady=2, padx  = (0,11),expand="true"  )

        self.logo_label1 = ctk.CTkLabel(self.mainFrame,text="",fg_color="dark blue",width=5,height=100,corner_radius=3)
        self.logo_label1.pack(side="left", padx  = (10,0)  )
        self.Student_label = ctk.CTkLabel(self.mainFrame, text=sub.count_all_rows(self),width=110,height=80,fg_color='white',text_color="dark blue",font=ctk.CTkFont(size=15, weight="bold"))
        self.Student_label.pack(side="left",fill="both",ipady=2, padx  = (0,10), expand="true" )

        self.logo_label1 = ctk.CTkLabel(self.mainFrame,text="",fg_color="dark blue",width=5,height=100,corner_radius=3)
        self.logo_label1.pack(side="left", padx  = (10,0)  )
        self.Subject_label = ctk.CTkLabel(self.mainFrame, text=teach.count_all_rows(self),width=110,height=50,fg_color='white',text_color="dark blue", font=ctk.CTkFont(size=15, weight="bold"))
    ...
    def startAttendance(self):
        Attendance.start_attendence(self.Subj_Name.get())
